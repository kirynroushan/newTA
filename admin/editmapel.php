			...
			<div class="row">			
				...
				<div class="col-12">
				  <div class="box">
					...
					<button><a href="mapel.php">Back</a></button>
					...
					<div class="box-body no-padding">
						...
						<?php
							...
							$id = $_GET['id'];
							$pkQ = mysql_query("SELECT * FROM pelajaran WHERE idp=$id");
							while($pk = mysql_fetch_array($pkQ)) {
							?>  
						<form action="editmapel.php" method="POST">
						  <table class="table table-hover">
                            <tr>
                                <th><input type="hidden" name="idp" value="<?php echo $id; ?>"></th>

                                <th>
                                    <label>Nama</label>
                                    <input type="text" name="nama" value="<?php echo $pk['nampel'];?>" required>
                                </th>
                                <th>
							...
							$id = $_POST['idp'];
                            $nama	= $_POST['nama'];
                            $update = mysql_query("UPDATE pelajaran SET nampel='$nama' WHERE idp='$id'") or die(mysql_error());
