				  ...
				  <div class="box">
					...
					<div class="box-body no-padding">
                        ...
                        if(isset($_POST['simpan'])){
                            ...
                            $nama	= $_POST['nama'];
                            $input = mysql_query("INSERT INTO pelajaran VALUES(NULL, '$nama')") or die(mysql_error());
                            
                            if($input){
                                
                                echo '<script>window.alert("BAGUS!!!");history.go(-2);</script>';
                            }else{
                                echo '<script>window.alert("gagal!!);history.go(-2);</script>';
                            }   
                        }
                        ?>
						</div>
