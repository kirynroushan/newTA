			...
			<div class="row">			
				...
				<div class="col-12">
				  <div class="box">
					...
					<button class="	"><a href="tambahbab.php">Tambah</a></button>
					...
					<div class="box-body no-padding">
						<div class="table-responsive">
                          ...
                          <?php
							...
							$query_mysql = mysql_query("SELECT * FROM bab_mapel INNER JOIN pelajaran ON bab_mapel.idp=pelajaran.idp")or die(mysql_error());
							$nomor = 1;
			              ...
			              <tbody>
							...
							<td>
								<a class="edit" href="editmapel.php?id=<?php echo $data['id']; ?>">Edit</a> |
								<a class="hapus" href="deletemapel.php?id=<?php echo $data['id']; ?>">Hapus</a>					
							</td>
						</tr>
