			...
			<div class="row">			
				...
				<div class="col-12">
				  <div class="box">
					...
					<button class="	"><a href="tambahmapel.php">Tambah</a></button>
					...
					<div class="box-body no-padding">
						<div class="table-responsive">
                          ...
                          <?php
							...
							$query_mysql = mysql_query("SELECT * FROM pelajaran")or die(mysql_error());
							$nomor = 1;
			              ...
			              <tbody>
							...
							<td><?php echo $data['nampel']; ?></td>
							<td>
								<a class="edit" href="editmapel.php?id=<?php echo $data['idp']; ?>">Edit</a> |
								<a onclick="javascript: return confirm('yakin ingin hapus?')" class="hapus" href="deletemapel.php?id=<?php echo $data['idp']; ?>">Hapus</a>					
							</td>
						</tr>
